        ...
        void control_send()
        {
            ...
            if (per2bank)
            {
                ...
                while (true)
                {
                    ...
                    if (time_to_refresh == sc_time(65 * model::tSYS_CK, SC_PS))
                    {
                        // 距离刷新太近，停止发送数据
        ...
        void dram_control()
        {
            if (per2bank)
            {
                ...
                while (true)
                {
                    ...
                    else if (time_to_refresh == sc_time(67 * tSYS_CK, SC_PS))
                    {
                        // 清空流水线流程 - 启动过程的逆过程
                        for (int phase = 0; phase < 8; phase++)
                        {
                            ...
                            for (int cycle = 0; cycle < 2; cycle++)
                            {
                                ...
                                {
                                    // 根据上一个cycle是谁在发命令决定是奇数还是偶数bank停止发命令
                                    int bank = last_active_bank == 1 ? group * 2 : group * 2 + 1;
            ...
            else
            {
                ...
                while (true)
                {
                    ...
                    else if (time_to_refresh <= sc_time(63 * tSYS_CK, SC_PS))
                    {
                        // 清空流水线流程 - 启动过程的逆过程
                        for (int phase = 0; phase < 8; phase++)
                        {
